...
// ObrashenieSvertki.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CObrashenieSvertkiApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CObrashenieSvertkiApp

CObrashenieSvertkiApp::CObrashenieSvertkiApp()
{
...
// Единственный объект CObrashenieSvertkiApp

CObrashenieSvertkiApp theApp;


// Инициализация CObrashenieSvertkiApp

BOOL CObrashenieSvertkiApp::InitInstance()
{
